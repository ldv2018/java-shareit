...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> postItem(ItemMessageDto dto, int userId) {
        return post("", userId, dto);
    }

    public ResponseEntity<Object> patchItem(ItemMessageDto dto, int userId, int itemId) {
    ...
    public ResponseEntity<Object> deleteItem(int itemId, int userId) {
    ...
    public ResponseEntity<Object> saveComment(CommentMessageDto dto, int userId, int itemId) {
